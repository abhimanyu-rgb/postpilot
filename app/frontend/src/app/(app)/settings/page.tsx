...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-[900px]">
      ...
      <div className="rounded-xl border border-violet-200 bg-violet-50/30 p-5 mb-6">
      ...
      <div className="rounded-xl border border-indigo-100/50 bg-white shadow-sm mb-6">
...
TIMEZONE=Asia/Kolkata`}</pre>
      ...
      {/* Account preferences */}
      <form onSubmit={handleSaveSettings} className="rounded-xl border border-indigo-100/50 bg-white shadow-sm">
        <div className="px-5 py-4 border-b border-indigo-50">
